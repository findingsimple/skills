...
> **Note:** `Incidents/_Index.md` is generated by `/incident-kb` (which has access to severity data), not by vault-linker. Sprint summary assignee names are intentionally left as plain text to avoid graph noise.
